...
# create an index for site-depth states to sites
site_depth_sites <- site_depth_lookup$site
...
constants_site_depth <- list(
  ...
  site_depth_sites = site_depth_sites
)
...
ggsave("Figures/Depth_occup_prob_V3.png", p1, 
       width = 8, height = 5, units = "in", dpi = 300)

ggsave("Figures/Volume_capture_prob_V3.png", p2, 
       width = 8, height = 5, units = "in", dpi = 300)

ggsave("Figures/Method_capture_prob_V3.png", p3, 
       width = 8, height = 5, units = "in", dpi = 300)

ggsave("Figures/Primer_detection_prob_V3.png", p4, 
       width = 8, height = 5, units = "in", dpi = 300)
